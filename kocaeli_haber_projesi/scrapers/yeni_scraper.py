...
class YeniKocaeliScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(
            site_adi="Yeni Kocaeli",
            ana_url="https://www.yenikocaeli.com/"
        )
    ...
    def haber_detay_cek(self, url):
        ...
        icerik_alani = (
            soup.find("div", class_="newsDetail") or
            soup.find("div", class_="haberDetay") or
    ...
    def scrape(self):
        ...
        for a in soup.find_all("a", href=True):
            ...
            if (
                ...
                any(k in link for k in ["/haber/", "/gundem/", "/guncel/", "/yerel/"]) and
                len(link) > 25
            ):
