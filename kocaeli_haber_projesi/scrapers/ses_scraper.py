...
class SesKocaeliScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(
            site_adi="Ses Kocaeli",
            ana_url="https://www.seskocaeli.com/"
        )
    ...
    def haber_detay_cek(self, url):
        ...
        icerik_alani = (
            soup.find("div", class_="news-detail") or
            soup.find("div", class_="haber-icerik") or
    ...
    def scrape(self):
        ...
        for a in soup.find_all("a", href=True):
            ...
            if (
                ...
                any(k in link for k in ["/haber/", "/gundem/", "/son-dakika/"]) and
                len(link) > 15
            ):
